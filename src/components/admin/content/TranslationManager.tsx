...
export default function TranslationManager({ content, onSave }: Props) {
            ...
            <div key={code} className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={translations[code as Language]?.title || ''}
                    ...
                    placeholder={`${content.title} in ${name}`}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    value={translations[code as Language]?.description || ''}
                    onChange={(e) => setTranslations(prev => ({
                      ...prev,
                      [code]: {
                        ...prev[code as Language],
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg
                      ...
                      resize-none"
                    rows={3}
                    placeholder={`${content.description} in ${name}`}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    value={translations[code as Language]?.content || ''}
                    onChange={(e) => setTranslations(prev => ({
                      ...prev,
                      [code]: {
                        ...prev[code as Language],
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg
                      ...
                      resize-none"
                    rows={6}
                    placeholder={`${content.content} in ${name}`}
                  />
                </div>
              </div>
            </div>
